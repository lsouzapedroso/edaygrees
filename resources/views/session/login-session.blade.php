              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="{{ route('login-post') }}">
                    ...
                    <label>Senha</label>
                    <div class="mb-3">
                      <input type="password" class="form-control" name="password" id="password" placeholder="Senha" aria-label="Password" aria-describedby="password-addon">
                      @error('password')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                    <div class="form-check form-switch">
                      ...
                      <label class="form-check-label" for="rememberMe">Lembrar meu login</label>
                    </div>
                ...
                <small class="text-muted">Esqueceu sua senha? Redefina sua senha
                  ...
                  <p class="mb-4 text-sm mx-auto">
                    Ainda não tem uma conta? Então
                    <a href="register" class="text-info text-gradient font-weight-bold">Crie sua conta</a>
                  </p>
                </div>
              </div>
            </div>
