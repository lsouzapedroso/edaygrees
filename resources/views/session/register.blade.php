...
@section('content')
  ...
  <section class="min-vh-100 mb-8">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 mx-3 border-radius-lg" style="background-image: url('images/0.jpg');">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  @error('agreement')
                    <p class="text-danger text-xs mt-2">E necessário que você esteja de acordo com os termos e condições</p>
                  @enderror
                </div>
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-info w-100 my-4 mb-2">Cadastre-se</button>
                </div>
                <p class="text-sm mt-3 mb-0">Já possui uma conta? Faça seu <a href="login" class="text-dark font-weight-bolder">Login</a></p>
              </form>
            </div>
          </div>
        </div>
